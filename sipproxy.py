...
class UDPHandler(socketserver.BaseRequestHandler):
    statusMessages = {
        100: "100 Pokus o pripojenie",
        180: "180 Vyzvanam",
        181: "181 Hovor je presmerovavany",
        182: "182 Zaradene do rady",
        183: "183 Hovor prebieha",

        200: "200 V poriadku",

        300: "300 Viac moznosti na vyber",
        301: "301 Permanentne presunuty",
        302: "302 Docasne presunuty",
        303: "303 We should see other people",
        305: "305 Pouzi proxy",
        380: "380 Alternativna sluzba",

        400: "400 Zla poziadavka",
        401: "401 Neautorizovany",
        402: "402 Je pozadovana platba",
        403: "403 Zakazane",
        404: "404 Nepodarilo sa najst",
        405: "405 Nepovolena metoda",
        406: "406 Neakceptovatelne",
        407: "407 Je pozadovana proxy autentifikacia",
        408: "408 Cas na poziadavku vyprsal",
        409: "409 Konflikt",  # Not in RFC3261
        410: "410 Gone, but not forgotten",
        411: "411 Pozaduje sa dlzka",  # Not in RFC3261
        413: "413 Request entita prilis velka",
        414: "414 Request-URI Too Large",  ## TODO
        415: "Nepodporovany typ media",
        416: "416 Nepodporovana URI schema",
        420: "420 Zla extenzia",
        421: "Extension Required",  ## TODO
        423: "Interval Too Brief",  ## TODO
        480: "Docasne nedostupne",
        481: "Hovor/transakcia neexistuje",
        482: "Loop Detected",  ## TODO
        483: "Too Many Hops",  ## TODO
        484: "Address Incomplete",  ## TODO
        485: "Ambiguous",  ## TODO
        486: "Zaneprazdneny",
        487: "Request Terminated",  ## TODO
        488: "Not Acceptable Here",  ## TODO
        491: "Request Pending",  ## TODO
        493: "Undecipherable",  ## TODO

        500: "Vnutorna chyba servera",
        501: "Not Implemented",  ## TODO
        502: "Bad Gateway",  # no donut
        503: "Sluzba nedostupna",
        504: "Server Time-out",
        505: "Nepodporovana verzia SIP",
        513: "Sprava prilis dlha",

        600: "Busy Everywhere",  ## TODO
        603: "Decline",  ## TODO
        604: "Does not exist anywhere",  ## TODO
        606: "Not Acceptable",  ## TODO
    }
    ...
    def processRegister(self):
        ...
        if expires == 0:
            ...
            if fromm in registrar.keys():
                del registrar[fromm]
                self.sendResponse(self.statusMessages[200])
                return
        else:
            now = int(time.time())
